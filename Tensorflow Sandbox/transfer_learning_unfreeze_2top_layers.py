...
output_layer_vars = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope="model/layer10/hidden[8910]|logits")
...
saving_path = "./minit_checkpoint/minist_model_5_9_unfreeze_2_top"
